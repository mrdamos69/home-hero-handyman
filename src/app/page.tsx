...
export const metadata: Metadata = {
  title: "Home Hero Service | Building Maintenance, Repairs & Welding in Los Angeles",
  description:
    "Commercial and residential building maintenance in Los Angeles — preventive upkeep, repairs, welding and maintenance contracts for apartment buildings, HOAs, commercial properties and homes.",
